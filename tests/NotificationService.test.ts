...
type ComplianceHistoryDTOType = typeof ComplianceHistoryDTO;

describe('NotifcationService', () => {
    let axiosGetStub: sinon.SinonStub;

    const complianceHistoryDTO: ComplianceHistoryDTOType = {
        teamName: 'Cydig',
        currentCompliance: { date: '2025-05-07', score: 70, maxScore: 100 },
        previousCompliance: { date: '2025-05-08', score: 90, maxScore: 100 },
    };

    const expected: ComplianceHistoryType = new ComplianceHistory(
        'Cydig',
